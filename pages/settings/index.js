...
export default function SettingsPage() {
  ...
  return (
    <>
      <Head>
        <title>Settings | Mttrader</title>
        <meta name="description" content="Manage your preferences and account settings on Mttrader" />
      </Head>
      ...
      <div className="min-h-screen flex bg-gradient-to-br from-[#0f172a] via-[#0b1120] to-black font-poppins text-white overflow-hidden">
        ...
        >
          <div className="flex flex-col h-full p-6">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <SidebarLink icon={<FaCogs />} label="Settings" href="/settings" active onClick={closeSidebar} />
            </nav>
        ...
        <div className="flex-1 flex flex-col min-h-screen overflow-hidden md:ml-72">
          <header className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-white/5 backdrop-blur-lg shadow-sm">
            ...
            <h1 className="text-xl font-bold text-cyan-300">Settings</h1>
            <div className="text-sm text-gray-300">🛠️ Customize your experience</div>
          </header>

          <main className="p-6 md:p-10 flex-1 overflow-y-auto">
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-cyan-400">Account Settings</h2>
              <p className="text-gray-400 mt-1">Manage your preferences, notifications, and account details.</p>
            </section>
            ...
            <section className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-6">
              ...
              <div>
                ...
                <select className="bg-white/10 border border-white/20 rounded-lg p-2 w-full text-gray-200 focus:outline-none">
              ...
              <div>
                ...
                <input type="password" placeholder="New password" className="bg-white/10 border border-white/20 rounded-lg p-2 w-full text-gray-200 focus:outline-none" />
              </div>

              <button className="mt-4 px-4 py-2 rounded-lg bg-cyan-500 text-white font-medium hover:bg-cyan-600 transition">
                Save Changes
              </button>
            </section>
          </main>
